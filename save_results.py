...
res_a = evaluate_caption_json(
    res_file=os.path.join(CURR_DIR, "tests", "test_a.json"), ann_file="captions_val2014.json"
)
res_b = evaluate_caption_json(
    res_file=os.path.join(CURR_DIR, "tests", "test_b.json"), ann_file="captions_val2014.json"
)
